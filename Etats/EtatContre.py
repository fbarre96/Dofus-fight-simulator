        ...
        if cibleAttaque.team != attaquant.team:
            ...
            if distance == 1:
                if typeDegats.lower() in ["terre","eau","air","feu","neutre"]:
                    ...
                    s=Sort.Sort("Contre",0,0,0,1,[EffetDegats(retour,retour,typeDegats,zone=Zones.TypeZoneCercle(self.tailleZone),cibles_possibles="Ennemis", bypassDmgCalc=True)],[],0,99,99,0,0,"cercle",False)
