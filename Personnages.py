...
class Personnage(object):
    ...
    def ChargerSorts(classe):
        ...
        if(classe==u"Stratège Iop"):
            ...
            sorts.append(Sort.Sort(u"Complice",2,1,5,[Effets.EffetInvoque("Complice",cibles_possibles="",faire_au_vide=True),Effets.EffetTue(cibles_possibles=u"Cadran de Xélor|Complice",zone=Zones.TypeZoneCercleSansCentre(99))], 1,1,0,0,"cercle",chaine=True,description=u"Invoque un Complice statique qui ne possède aucun sort. Il est tué si un autre Complice est invoqué."))
            ...
            sorts.append(Sort.Sort(u"Synchro",2,1,4,[Effets.EffetInvoque("Synchro",cibles_possibles="",faire_au_vide=True)], 1,1,3,0,"cercle",description=u"Invoque Synchro qui gagne en puissance et se soigne quand un Téléfrag est généré, 1 fois par tour. La Synchro meurt en occasionnant des dommages Air en zone de 3 cases si elle subit un Téléfrag. Elle n'est pas affectée par les effets de Rembobinage. À partir du tour suivant son lancer, son invocateur perd 1 PA."))
            ...
            sorts.append(Sort.Sort(u"Anneau Destructeur",3,0,2,[Effets.EffetDegats(26,30,"air",zone=Zones.TypeZoneAnneau(3)), Effets.EffetAttire(1,zone=Zones.TypeZoneAnneau(3))], 2,2,0,0,"cercle",description=u"Occasionne des dommages Air en anneau et attire les cibles."))
            ...
            sorts.append(Sort.Sort(u"Souffle",2,2,8,[Effets.EffetPousser(1,zone=Zones.TypeZoneCroix(1),faire_au_vide=True)],1,1,2,0,"cercle",description=u"Repousse les alliés et les ennemis situés autour de la cellule ciblée."))
            ...
            sorts.append(Sort.Sort(u"Flèche Enflammée",4,1,8,[Effets.EffetDegats(33,35,"feu",zone=Zones.TypeZoneLigne(5)),Effets.EffetPousser(1,zone=Zones.TypeZoneLigne(5))],2,2,0,1,"ligne",description=u"Occasionne des dommages Feu et pousse les cibles présentes dans la zone d'effet du sort."))
            ...
            sorts.append(Sort.Sort(u"Balise de Rappel",2,1,5,[Effets.EffetInvoque("Balise_de_rappel",cibles_possibles="",faire_au_vide=True)],1,1,2,0,"cercle",description=u"Invoque une balise qui échange sa position avec celle du lanceur (au début du prochain tour)."))
            ...
            sorts.append(Sort.Sort(u"Balise Tactique",1,1,10,[Effets.EffetInvoque("Balise_tactique",cibles_possibles="", faire_au_vide=True)],1,1,2,1,"cercle",description=u"Invoque une Balise qui peut servir d'obstacle et de cible. La Balise subit 2 fois moins de dommages des alliés."))
            ...
            fleche_fulminante=Sort.Sort(u"Flèche Fulminante",4,1,8,[Effets.EffetDegats(34,38,"feu",cibles_possibles="Ennemis|Balise_tactique"),Effets.EffetEtatSelf(Etats.EtatBoostBaseDeg("Fleche_Fulminante_boost",0,1,u"Flèche Fulminante Rebond",10))],1,1,0,1,"cercle",description=u"Occasionne des dommages Feu. Se propage sur l'ennemi le plus proche dans un rayon de 2 cellules. Peut rebondir sur la Balise Tactique. À chaque cible supplémentaire, les dommages du sort sont augmentés.")
            fleche_fulminante_rebond=Sort.Sort(u"Flèche Fulminante Rebond",0,0,99,[Effets.EffetDegats(34,38,"feu",cibles_possibles="Ennemis|Balise_tactique"),Effets.EffetEtatSelf(Etats.EtatBoostBaseDeg("Fleche_Fulminante_boost",0,1,u"Flèche Fulminante Rebond",10))],9,1,0,0,"cercle",description=u"Occasionne des dommages Feu. Se propage sur l'ennemi le plus proche dans un rayon de 2 cellules. Peut rebondir sur la Balise Tactique. À chaque cible supplémentaire, les dommages du sort sont augmentés.")
        ...
        sorts.append(Sort.Sort(u"Cawotte",4,1,6,[Effets.EffetInvoque("Cawotte",cibles_possibles="", faire_au_vide=True)], 1,1,6,0,"cercle",description=u"Invoque une Cawotte")) 
