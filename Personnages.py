...
class Personnage(object):
    ...
    def ChargerSorts(classe):
        ...
        if(classe=="Stratège Iop"):
            ...
            sorts.append(Sort.Sort("Oeil de Taupe",3,5,10,[Effets.EffetVolDeVie(16,18,"eau",zone=Zones.TypeZoneCercle(3)),Effets.EffetEtat(Etats.EtatBoostPO("Oeil_de_taupe",1,3,-3),zone=Zones.TypeZoneCercle(3)),Effets.EffetRetireEtat("Invisibilite",zone=Zones.TypeZoneCercle(3))],1,1,4,1,"cercle",description="Réduit la portée des personnages ciblés, vole de la vie dans l'élément Eau et repère les objets invisibles dans sa zone d'effet."))
