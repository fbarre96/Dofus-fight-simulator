...
class Personnage(object):
    ...
    def ChargerSorts(classe):
        ...
        if(classe==u"Stratège Iop"):
            ...
            sorts.append(Sort(u"Flèche du Jugement",3,5,7,[EffetDegats(39,45,"terre")],3,2,0,1,"cercle",description=u"Occasionne des dommages Terre. Plus le pourcentage de PM du personnage au lancement du sort est important, plus les dommages occasionnés sont importants."))
            ...
            sorts.append(Sort(u"Flèche Harcelante",3,1,7,[EffetDegats(13,15,"air")],1,1,2,1,"cercle",description=u"Occasionne des dommages Air sans ligne de vue."))
            sorts.append(Sort(u"Flèche Massacrante",4,4,8,[EffetDegats(34,38,"air"),EffetEtatSelf(EtatBoostBaseDeg("Fleche_massacrante",1,1,u"Flèche Massacrante",10))],3,2,0,1,"ligne",description=u"Occasionne des dommages Air. Les dommages du sort sont augmentés au tour suivant."))
            sorts.append(Sort(u"Flèche Empoisonnée",3,1,10,[EffetRetPM(3),EffetEtat(EtatEffetDebutTour("Fleche_empoisonnee", 1,2,EffetDegats(17,18,"terre"),"Fleche_empoisonnee","lanceur"))],4,1,0,1,"cercle",description=u"Occasionne des dommages Neutre sur plusieurs tours et retire des PM."))
            ...
            sorts.append(Sort(u"Sentinelle",2,0,0,[EffetEtatSelf(EtatBoostPerDommageSorts("Sentinelle",1,1,30)),EffetEtatSelf(EtatBoostPM("Sentinelle",1,1,-100))],1,1,3,0,"cercle",description=u"Au tour suivant, le lanceur perd tous ses PM mais gagne un bonus de dommages."))
