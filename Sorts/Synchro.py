...
def getSortsDebutCombat(lvl):
    ...
    sortsDebutCombat.append(
        Sort.Sort("Synchronisation",0,0,0,0,[
            EffetEtatSelf(Etats.EtatEffetSiTFGenere("Synchronisation",0,-1,[EffetEtatSelfTF(Etats.EtatBoostBaseDegLvlBased("toReplace",0,-1,"Fin des temps",190), "Rembobinage", cumulMax=1, etat_requis="!DejaBoost"),EffetEtatSelfTF(Etats.Etat("DejaBoost",0,1), "Rembobinage", remplaceNom=False, cumulMax=1)],"Téléfrageur","porteur","porteur")), 
            EffetEtatSelf(Etats.EtatEffetSiTFGenere("Attente de la fin des temps",0,-1,EffetEntiteLanceSort("Synchro",activationFinDesTemps),"Téléfrageur","porteur","porteur",True,"Rembobinage"))],[],0,99,99,0,0,"cercle",False,description="""""", chaine=False)
    )
