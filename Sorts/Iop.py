...
def getSorts(lvl):
    ...
    sorts.append(Personnages.Personnage.getSortRightLvl(lvl,[
        Sort.Sort("Pression",1,3,1,3,[EffetEtat(EtatBoostCaracFixe("Pression",0,2,"erosion",10),cibles_possibles="Ennemis"),EffetDegats(14,18,"Terre")],[EffetEtat(EtatBoostCaracFixe("Pression",0,2,"erosion",10),cibles_possibles="Ennemis"),EffetDegats(19,23,"Terre")],5,99,2,0,0,"cercle",True,description="""Occasionne des dommages Terre et applique un malus d'érosion.""", chaine=True),
        Sort.Sort("Pression",30,3,1,3,[EffetEtat(EtatBoostCaracFixe("Pression",0,2,"erosion",10),cibles_possibles="Ennemis"),EffetDegats(19,23,"Terre")],[EffetEtat(EtatBoostCaracFixe("Pression",0,2,"erosion",10),cibles_possibles="Ennemis"),EffetDegats(24,28,"Terre")],5,99,2,0,0,"cercle",True,description="""Occasionne des dommages Terre et applique un malus d'érosion.""", chaine=True),
        Sort.Sort("Pression",60,3,1,3,[EffetEtat(EtatBoostCaracFixe("Pression",0,2,"erosion",10),cibles_possibles="Ennemis"),EffetDegats(24,28,"Terre")],[EffetEtat(EtatBoostCaracFixe("Pression",0,2,"erosion",10),cibles_possibles="Ennemis"),EffetDegats(29,33,"Terre")],5,99,3,0,0,"cercle",True,description="""Occasionne des dommages Terre et applique un malus d'érosion.""", chaine=True)
    ]))
    sorts.append(Personnages.Personnage.getSortRightLvl(lvl,[
    ...
    sorts.append(Personnages.Personnage.getSortRightLvl(lvl,[
        Sort.Sort("Epée Divine",6,3,0,0,[EffetDegats(15,17,"Air",zone=Zones.TypeZoneCroix(3), cibles_possibles="Ennemis"),EffetEtat(EtatBoostCaracFixe("Epée Divine",0,4,"do",10),zone=Zones.TypeZoneCroix(3), cibles_possibles="Allies|Lanceur")],[EffetDegats(24,24,"Air",zone=Zones.TypeZoneCroix(3), cibles_possibles="Ennemis"),EffetEtat(EtatBoostCaracFixe("Epée Divine",0,4,"do",13),zone=Zones.TypeZoneCroix(3), cibles_possibles="Allies|Lanceur")],5,2,99,0,0,"cercle",False,description="""Occasionne des dommages Air et augmente les dommages des alliés ciblés.""", chaine=False),

        Sort.Sort("Epée Divine",42,3,0,0,[EffetDegats(18,20,"Air",zone=Zones.TypeZoneCroix(3), cibles_possibles="Ennemis"),EffetEtat(EtatBoostCaracFixe("Epée Divine",0,4,"do",15),zone=Zones.TypeZoneCroix(3), cibles_possibles="Allies|Lanceur")],[EffetDegats(27,27,"Air",zone=Zones.TypeZoneCroix(3), cibles_possibles="Ennemis"),EffetEtat(EtatBoostCaracFixe("Epée Divine",0,4,"do",18),zone=Zones.TypeZoneCroix(3), cibles_possibles="Allies|Lanceur")],5,2,99,0,0,"cercle",False,description="""Occasionne des dommages Air et augmente les dommages des alliés ciblés.""", chaine=False),

        Sort.Sort("Epée Divine",74,3,0,0,[EffetDegats(21,23,"Air",zone=Zones.TypeZoneCroix(3), cibles_possibles="Ennemis"),EffetEtat(EtatBoostCaracFixe("Epée Divine",0,4,"do",20),zone=Zones.TypeZoneCroix(3), cibles_possibles="Allies|Lanceur")],[EffetDegats(30,30,"Air",zone=Zones.TypeZoneCroix(3), cibles_possibles="Ennemis"),EffetEtat(EtatBoostCaracFixe("Epée Divine",0,4,"do",23),zone=Zones.TypeZoneCroix(3), cibles_possibles="Allies|Lanceur")],5,2,99,0,0,"cercle",False,description="""Occasionne des dommages Air et augmente les dommages des alliés ciblés.""", chaine=False)
    ]))
    sorts.append(Personnages.Personnage.getSortRightLvl(lvl,[
    ...
    sorts.append(Personnages.Personnage.getSortRightLvl(lvl,[
        ...
        Sort.Sort("Massacre",54,2,1,5,[EffetEtat(EtatRedistribuerPer("Massacre",0,2,50,"Allies",1))],[],0,1,1,3,0,"cercle",True,description="""Lorsque la cible ennemie reçoit des dommages de sorts, elle occasionne 50% de ces dommages aux ennemis au contact.""", chaine=True),

        Sort.Sort("Massacre",94,2,1,7,[EffetEtat(EtatRedistribuerPer("Massacre",0,2,50,"Allies",1))],[],0,1,1,3,0,"cercle",True,description="""Lorsque la cible ennemie reçoit des dommages de sorts, elle occasionne 50% de ces dommages aux ennemis au contact.""", chaine=True)
    ]))
    sorts.append(Personnages.Personnage.getSortRightLvl(lvl,[
    ...
    sorts.append(Personnages.Personnage.getSortRightLvl(lvl,[
        Sort.Sort("Emprise",155,3,1,1,[EffetEtat(EtatModDegPer("Emprise: Invulnérable",0,1, 0)),EffetEtat(EtatBoostCaracFixe("Emprise",0,1,"PM",-100))],[],0,1,1,4,0,"cercle",False,description="""Retire tous les PM de l'ennemi cible mais le rend invulnérable.""", chaine=True)
    ]))
    sorts.append(Personnages.Personnage.getSortRightLvl(lvl,[
    ...
    sorts.append(Personnages.Personnage.getSortRightLvl(lvl,[
        Sort.Sort("Condamnation",160,3,1,6,[
            ...
            EffetEtat(Etat("Condamnation 2",0,-1),etat_requis_cibles="Condamnation 1",consomme_etat=True),
            EffetDegats(25,29,"feu",zone=Zones.TypeZoneCercleSansCentre(99),etat_requis_cibles="Condamnation 1",consomme_etat=True),
            EffetEtat(Etat("Condamnation 1",0,-1),etat_requis_cibles="!Condamnation 2"),
    ...
    sorts.append(Personnages.Personnage.getSortRightLvl(lvl,[
        Sort.Sort("Puissance",50,3,0,2,[EffetEtat(EtatBoostCaracFixe("Puissance",0,2,"pui",100))],[EffetEtat(EtatBoostCaracFixe("Puissance",0,2,"pui",120))],15,1,1,3,0,"cercle",True,description="""Augmente la Puissance de la cible.""", chaine=True),

        Sort.Sort("Puissance",103,3,0,4,[EffetEtat(EtatBoostCaracFixe("Puissance",0,2,"pui",200))],[EffetEtat(EtatBoostCaracFixe("Puissance",0,2,"pui",240))],15,1,1,3,0,"cercle",True,description="""Augmente la Puissance de la cible.""", chaine=True),

        Sort.Sort("Puissance",143,3,0,6,[EffetEtat(EtatBoostCaracFixe("Puissance",0,2,"pui",300))],[EffetEtat(EtatBoostCaracFixe("Puissance",0,2,"pui",350))],15,1,1,3,0,"cercle",True,description="""Augmente la Puissance de la cible.""", chaine=True)
    ]))
    sorts.append(Personnages.Personnage.getSortRightLvl(lvl,[
        Sort.Sort("Vertu",165,3,0,0,[EffetEtat(EtatBouclierPerLvl("Vertu : bouclier",0,2,500),zone=Zones.TypeZoneCroix(1)),EffetEtat(EtatBoostCaracFixe("Vertu: malus puissance",0,2,"pui",-150))],[],0,1,1,3,0,"cercle",False,description="""Applique un bouclier zone mais réduit la Puissance du lanceur.""", chaine=True)
    ]))
    sorts.append(Personnages.Personnage.getSortRightLvl(lvl,[
    ...
    sorts.append(Personnages.Personnage.getSortRightLvl(lvl,[
        Sort.Sort("Agitation",170,2,0,5,[EffetEtat(EtatBoostCaracFixe("Agitation",0,1,"PM",2)),EffetEtat(EtatBoostCaracFixe("Intaclable",0,1,"fuite",999999))],[],0,1,1,2,0,"cercle",True,description="""Augmente les PM et rend Intaclable pour le tour en cours.""", chaine=True)
    ]))
    sorts.append(Personnages.Personnage.getSortRightLvl(lvl,[
